...
//
// NOTE:  This wxWidgets project was originally written as an MFC project
//        So, YES, it i possible to port MFC applications to X11 using
//        wxWidgets.  It takes a bit of effort, but it CAN be done.
//
...
#include <sys/time.h> // was timeb.h, not using that any more
